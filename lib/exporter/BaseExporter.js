...
var BaseExporter = /** @class */ (function () {
    ...
    BaseExporter.prototype.extractValues = function (values) {
        throw new Error('unimplemented method extractValues');
        var extractedValues = BaseExporter.keyPathExtractor(values, this.output.keyPathSeparator || '.');
        return JSON.stringify(extractedValues, null, 2);
    };
    BaseExporter.prototype.defaultFileName = function (locale) {
        throw new Error('unimplemented method extractValues');
