...
var YAMLExporter = /** @class */ (function (_super) {
    __extends(YAMLExporter, _super);
    function YAMLExporter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    YAMLExporter.prototype.extractValues = function (values) {
    ...
    YAMLExporter.prototype.defaultFileName = function (locale) {
        return "".concat(locale, ".yml");
    };
    return YAMLExporter;
